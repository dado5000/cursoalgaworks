...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter{
	...
	public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
		clients.inMemory()
				.withClient("angular")
				.secret("$2a$10$LBEyPTIUatWAroTiCSQP0uTAvd2LGUh9a//hzHAg96HHYJT.pGBna") // @ngul@r0
				.scopes("read", "write")
			...
			.and()
				.withClient("mobile")
				.secret("$2a$10$2/Mp92I0blCXN4KS3t9FAeft0xG9uto3vuI3tmF5WkTlsvWc1bJY.") // m0b1l30
				.scopes("read")
				.authorizedGrantTypes("password", "refresh_token")
